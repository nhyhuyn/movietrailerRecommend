// ignore_for_file: curly_braces_in_flow_control_structures, unnecessary_this, prefer_interpolation_to_compose_strings, camel_case_types, prefer_typing_uninitialized_variables, use_super_parameters, prefer_const_constructors_in_immutables, avoid_print, non_constant_identifier_names

import 'package:flutter/material.dart';
import 'package:dio/dio.dart';
import 'package:hexcolor/hexcolor.dart';
import 'package:movie_app/Screens/MoreMoviesPage/Widgets/MovieCard.dart';
        ...
        child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            return MovieCard(
              ...
              url:
                  popularlist[index]["poster_path"].toString() == "null"
                      ? "NULL"
