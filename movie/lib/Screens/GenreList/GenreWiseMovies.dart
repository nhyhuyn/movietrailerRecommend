// ignore_for_file: prefer_typing_uninitialized_variables, use_super_parameters, unnecessary_this
...
class GenreWiseMovies extends StatelessWidget {
  ...
  const GenreWiseMovies({Key? key, required this.genre, required this.id})
    : super(key: key);
